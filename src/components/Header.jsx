        ...
        <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black'>
            ...
            <div className="flex h-5 items-center">
                {pageName !== "video" && (
                    ...
                    >
                        {mobileMenu ? (
                            <CgClose className='text-xl text-white'></CgClose>
                        ) : (
                            <SlMenu className='text-xl text-white'></SlMenu>
                        )}

                    </div>
                )}
                
                <img className='h-full hidden dark:md:block' src={ytLogo} alt="logo" />
                <img className='h-full md:hidden' src={ytLogoMobile} alt="logoMobile" />
            </div>
        </div>
    );
};
